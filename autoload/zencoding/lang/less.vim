function! zencoding#lang#less#findTokens(str)
  return zencoding#lang#html#findTokens(a:str)
endfunction

function! zencoding#lang#less#parseIntoTree(abbr, type)
  if a:abbr =~ '>'
...
function! zencoding#lang#less#toString(settings, current, type, inline, filters, itemno, indent)
...
function! zencoding#lang#less#imageSize()
  call zencoding#lang#css#imageSize()
endfunction

function! zencoding#lang#less#encodeImage()
  return zencoding#lang#css#encodeImage()
endfunction

function! zencoding#lang#less#parseTag(tag)
  return zencoding#lang#css#parseTag(a:tag)
endfunction

function! zencoding#lang#less#toggleComment()
  call zencoding#lang#css#toggleComment()
endfunction

function! zencoding#lang#less#balanceTag(flag) range
...
function! zencoding#lang#less#moveNextPrev(flag)
  call zencoding#lang#css#moveNextPrev(a:flag)
endfunction

function! zencoding#lang#less#splitJoinTag()
  call zencoding#lang#css#splitJoinTag()
endfunction

function! zencoding#lang#less#removeTag()
